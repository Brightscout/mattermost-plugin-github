...
func (p *PullRequestService) GetReviewRequestedPrs() ([]*github.Issue, error) {
	params := map[string]interface{}{
		queryParamPRSearchQuery: githubv4.String(fmt.Sprintf("review-requested:%s is:pr is:%s archived:false", p.client.username, githubv4.PullRequestStateOpen)),
		queryParamPRsCursor:     (*githubv4.String)(nil),
	}
